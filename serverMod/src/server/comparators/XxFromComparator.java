...
/**
 * Класс, который позволяет сравнивать объекты по критерию модуля разности текущей координаты x и координаты x начальной локации маршрута
 *
 * @author Саня Малета и Хумай Байрамова
 * @version final
 */
public class XxFromComparator implements Comparator<Route> {
    ...
    public int compare(Route a, Route b) {
        Long x1 = Math.abs(a.getCoordinates().getX() - a.getFrom().getX());
        Long x2 = Math.abs(b.getCoordinates().getX() - a.getFrom().getX());
